...
public class BlinkyPeriodicDirectionManagerTest {
  ...
  public void updateDesiredDirectionWhenPeriodsReached()
    ...
    BlinkyPeriodicDirectionManager directionManager =
        new BlinkyPeriodicDirectionManager(model, mockDirectionGenerator, ghost, 2);
  ...
  public void whenAfraidAndPacmanInLineOfSightThenMoveInOppositeDirection() {
    ...
    BlinkyPeriodicDirectionManager directionManager =
        new BlinkyPeriodicDirectionManager(model, null, ghost, 1);
  ...
  public void whenNotAfraidAndPacmanInLineOfSightThenFollowDirectionGenerator() {
    ...
    BlinkyPeriodicDirectionManager directionManager =
        new BlinkyPeriodicDirectionManager(model, mockDirectionGenerator, ghost, 1);

...
public class InkyPeriodicDirectionManagerTest {
  ...
  public void updateDesiredDirectionWhenPeriodsReached()
    ...
    InkyPeriodicDirectionManager directionManager =
        new InkyPeriodicDirectionManager(model, mockDirectionGenerator, ghost, 2);
  ...
  public void whenAfraidAndPacmanInLineOfSightThenMoveInOppositeDirection() {
    ...
    InkyPeriodicDirectionManager directionManager =
        new InkyPeriodicDirectionManager(model, null, ghost, 1);
  ...
  public void whenNotAfraidAndPacmanInLineOfSightThenFollowDirectionGenerator() {
    ...
    InkyPeriodicDirectionManager directionManager =
        new InkyPeriodicDirectionManager(model, mockDirectionGenerator, ghost, 1);

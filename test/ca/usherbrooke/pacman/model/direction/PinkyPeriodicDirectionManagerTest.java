...
public class PinkyPeriodicDirectionManagerTest {
  ...
  public void updateDesiredDirectionWhenPeriodsReached()
    ...
    PinkyPeriodicDirectionManager directionManager =
        new PinkyPeriodicDirectionManager(model, mockDirectionGenerator, ghost, 2);
  ...
  public void whenAfraidAndPacmanInLineOfSightThenMoveInOppositeDirection() {
    ...
    PinkyPeriodicDirectionManager directionManager =
        new PinkyPeriodicDirectionManager(model, null, ghost, 1);
  ...
  public void whenNotAfraidAndPacmanInLineOfSightThenFollowDirectionGenerator() {
    ...
    PinkyPeriodicDirectionManager directionManager =
        new PinkyPeriodicDirectionManager(model, mockDirectionGenerator, ghost, 1);

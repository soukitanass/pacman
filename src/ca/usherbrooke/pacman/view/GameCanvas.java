...
public class GameCanvas extends JPanel {
	...
	public int getPixelTileSize() {
		...
		final int availableWindowWidthPixels = (int) Math.min(panelWidthPixels, 3.0 / 4.0 * panelHeightPixels);
		final int availableWindowHeightPixels = (int) Math.min(panelHeightPixels, 4.0 / 3.0 * panelWidthPixels);
	...
	public void setPausePanel() {
		pausePanel = new PausePanel(model);
